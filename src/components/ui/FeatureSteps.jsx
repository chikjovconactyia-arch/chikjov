    ...
    return (
        <div className={cn("p-8 md:p-12", className)}>
            <div className="max-w-7xl mx-auto w-full">
                {/* Title is handled by the parent component usually, but keeping it here as per component definition */}
          ...
          {title}
                ...
                <div className="flex flex-col md:grid md:grid-cols-2 gap-6 md:gap-10">
                    ...
                    <div
                        className={cn(
                            "order-1 md:order-2 relative overflow-hidden rounded-2xl shadow-xl",
                            imageHeight
                        )}
                    >
